/*
  ...
  - You are about to alter the column `middle_name` on the `User` table. The data in that column could be lost. The data in that column will be cast from `Text` to `VarChar(255)`.
